...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MINEUM " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
{"70.83.227.32", "70.83.227.32"},
{"70.183.152.210", "70.183.152.210"},
{"70.183.152.14", "70.183.152.14"},
{"213.187.241.48", "213.187.241.48"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MINEUM is probably already running."), addrBind.ToString().c_str());
        else
